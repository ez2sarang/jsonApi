...
var demo_themes = [
  { name: 'default', title: 'Default', img: ctxRoot + '/assets/demo/themes/default.png' },
  { name: 'asphalt', title: 'Asphalt', img: ctxRoot + '/assets/demo/themes/asphalt.png' },
  { name: 'purple-hills', title: 'Purple Hills', img: ctxRoot+'/assets/demo/themes/purple-hills.png' },
  { name: 'adminflare',  title: 'Adminflare', img: ctxRoot + '/assets/demo/themes/adminflare.png' },
  { name: 'dust',  title: 'Dust', img: ctxRoot + '/assets/demo/themes/dust.png' },
  { name: 'frost',  title: 'Frost', img: ctxRoot + '/assets/demo/themes/frost.png' },
  { name: 'fresh',  title: 'Fresh', img: ctxRoot + '/assets/demo/themes/fresh.png' },
  { name: 'silver',  title: 'Silver', img: ctxRoot + '/assets/demo/themes/silver.png' },
  { name: 'clean',  title: 'Clean', img: ctxRoot + '/assets/demo/themes/clean.png' },
  { name: 'white',  title: 'White', img: ctxRoot + '/assets/demo/themes/white.png' }
];
