...
<script language="JavaScript">
	$(document).ready(function() {
		...
		*/
		...
		$("#contractId").val("${offer.contractId}").select2();
		$("#promotionalContentGroupRef").val("${offer.promotionalContentGroupRef}").select2();
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<form:select path="termsTarget" cssClass="form-control">
						...
						<ccode:options groupCode="${const:get('COMMONCODE', 'GROUP_CODE_TERMS_TARGET')}" selected="${offer.termsTarget}"/>
					</form:select>
				</div>
			</div>
			<div class="form-group">
					...
					<div class="input-group">
						<div class="select2-success">
							<form:select path="contractId" cssClass="form-control" multiple="multiple">
								<form:option value="${offer.contractId}"><lvb:label	serviceBeanName="contractService" key1="${offer.contractId}" /></form:option>
							</form:select>
						</div>
				...
				<div class="col-sm-9">
					<div class='col-md-3' style="padding-left:0;padding-right:0">
		                <div class='input-group'>
		                	...
		                	<input type="text" id="rentalPeriodYear" name="rentalPeriodYear" value="${rentalPeriod.years==0?'':rentalPeriod.years}" class="form-control" placeholder="<spring:message code='offer.rentalPeriod.year'/>"/>
		                </div>
			        </div>
					<div class='col-md-3' style="padding-left:0;padding-right:0">
		                <div class='input-group'>
		                	<input type="text" id="rentalPeriodMonth" name="rentalPeriodMonth" value="${rentalPeriod.months==0?'':rentalPeriod.months}" class="form-control" placeholder="<spring:message code='offer.rentalPeriod.month'/>" />
		                </div>
			        </div>
					<div class='col-md-3' style="padding-left:0;padding-right:0">
		                <div class='input-group'>
		                	<input type="text" id="rentalPeriodDay" name="rentalPeriodDay" value="${rentalPeriod.days==0?'':rentalPeriod.days}" class="form-control" placeholder="<spring:message code='offer.rentalPeriod.day'/>" />
		                </div>
			        </div>
					<div class='col-md-3' style="padding-left:0;padding-right:0">
		                <div class='input-group'>
		                	<input type="text" id="rentalPeriodHour" name="rentalPeriodHour" value="${rentalPeriod.hours==0?'':rentalPeriod.hours}" class="form-control" placeholder="<spring:message code='offer.rentalPeriod.hour'/>" />
		                </div>
			        </div>
				</div>
			</div>
						...
						<div class="select2-success">
							<select id="contentGroupIds" name="contentGroupIds" class="orm-control" multiple="multiple">
								<c:forEach items="${offer.contentGroupList}" var="contentGroup">
									<option value="${contentGroup.contentGroupId}" selected="selected">${contentGroup.titleBrief}</option>
								</c:forEach>
							</select>
						</div>
						<span class="input-group-btn">
					...
					<div class="input-group">
						<div class="select2-success">
							<form:select path="promotionalContentGroupRef" cssClass="form-control" multiple="multiple">
								<form:option value="${offer.promotionalContentGroupRef}"><lvb:label	serviceBeanName="contentGroupService" key1="${offer.promotionalContentGroupRef}" /></form:option>
							</form:select>
						</div>
						<span class="input-group-btn">
					...
					<div class="input-group">
						<div class="select2-success">
							<select id="categoryInfos" name="categoryInfos" class="orm-control" multiple="multiple">
								<c:forEach items="${offer.offerCategoryList}" var="offerCategory">
									<option value="${offerCategory.categoryId}_${offerCategory.displayDaysAsNew}_${offerCategory.displayDaysAsLastChance}_${offerCategory.priority}" selected="selected">
