		...
		$('#series').validate( {
			...
			submitHandler: function () {
				...
				try{
					$.ajax({
						type: "POST",
						url: "${ctxRoot}/asset/editSeries.do",
...
<!-- 10. $FORM_EXAMPLE =============================================================================
				...
				Form example
-->
	<form:form modelAttribute="series" cssClass="panel form-horizontal" >
		<div class="panel-heading">
			<span class="panel-title"><i class="fa fa-ellipsis-v"></i> &nbsp; <spring:message code="series.title.edit"/></span>
		</div>
