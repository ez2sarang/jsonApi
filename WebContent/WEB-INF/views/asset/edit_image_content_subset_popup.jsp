		...
		$('#contentSubset').validate( {
			...
			submitHandler: function () {
				...
				try{
					...
					$.ajax({
						type: "POST",
						url: "${ctxRoot}/asset/editImageContentSubset.do",
						data: formData,
						cache: false,
					    contentType: false,
					    processData: false,
	...
	<form:form modelAttribute="contentSubset" method="POST"
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div>
						<i class="fa fa-lightbulb-o" id="unlimitButton" style="cursor: pointer;"></i>&nbsp;&nbsp;&nbsp;<spring:message code="contentSubset.label.noSelectNoChange" />
					</div>
