function openInform(msgTitle, msgText, callback) {
	$("#zimin-modals-alerts-success .modal-title").html(msgTitle);
	$("#zimin-modals-alerts-success .modal-body").html(msgText);
	$("#zimin-modals-alerts-success").modal('show');
	$('#zimin-modals-alerts-success').off('hidden.bs.modal').on('hidden.bs.modal', callback);
}

function openAlert(msgTitle, msgText, callback) {
	$("#zimin-modals-alerts-danger .modal-title").html(msgTitle);
	$("#zimin-modals-alerts-danger .modal-body").html(msgText);
	$("#zimin-modals-alerts-danger").modal('show');
	$('#zimin-modals-alerts-danger').off('hidden.bs.modal').on('hidden.bs.modal', callback);
}

function openConfirm(msgText, callback) {
    $('#zimin-modals-alerts-warning').modal({
    	show: true,
        backdrop: false,
        keyboard: false
    });
    $("#zimin-modals-alerts-warning .modal-body").html(msgText);
    $('#zimin-modals-alerts-warning').off('click.confirm').on('click.confirm', function () {
    	var str = $("#zimin-modals-alerts-warning .modal-body").html();
    	if (str == 'OK') {
        ...
        .append(
            ...
            .append(
                ...
                .append(
                    ...
                    .append($('<button type="button" class="btn btn-success">').on("click", function(){$('#zimin-modals-alerts-success').modal('hide');}).text("OK"))
                )
            )
        )
    )
    .append(/*Danger*/
        ...
        .append(
            ...
            .append(
                ...
                .append(
                    $('<div class="modal-footer">')
                    .append($('<button type="button" class="btn btn-danger">').on("click", function(){$('#zimin-modals-alerts-danger').modal('hide');}).text("OK"))
                )
            )
        )
    )
    .append(/*Warning*/
        ...
        .append(
            ...
            .append(
                ...
                .append(
                    $('<div class="modal-footer">')
                    .append($('<button type="button" class="btn btn-default" id="confirmFalse" data-dismiss="modal">').on("click", function(){$('#zimin-modals-alerts-warning .modal-body').html('Cancel');}).text("Cancel"))
                    .append($('<button type="button" class="btn btn-warning" id="confirmTrue" data-dismiss="modal">').on("click", function(){$('#zimin-modals-alerts-warning .modal-body').html('OK');}).text("OK"))
                )
            )
        )
    )
